defmodule GlixBackEnd.Accounts.User do
  use Ash.Resource,
  ...
  authentication do
    add_ons do
      ...
      confirmation :confirm_new_user do
        ...
        sender GlixBackEnd.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end

    tokens do
      enabled? true
      token_resource GlixBackEnd.Accounts.Token
      signing_secret GlixBackEnd.Secrets
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender GlixBackEnd.Accounts.User.Senders.SendPasswordResetEmail
  ...
  actions do
    ...
    create :register_with_password do
      ...
      argument :username, :string do
        description "The proposed nickname for the user."
        allow_nil? false
        sensitive? true
      end
